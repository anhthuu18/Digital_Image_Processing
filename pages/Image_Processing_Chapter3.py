...
def InsertImage(image_file,path=''):
	...
	if image_file is not None:
		...
		image = Image.open("./images/ImageProcessing_Chapter3/"+path) # You must transfome your picture into grey
		c1.image(image, caption=None)
		image.close()
...
def Chosen_Proccesing(option,path=''):
	...
	if(option == '1. Negative Image.'):
		...
		image_temp = cv2.imread("./images/ImageProcessing_Chapter3/"+path,cv2.IMREAD_COLOR)
